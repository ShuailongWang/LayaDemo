...
export default class CurrentTool{
    static transVertex0: Laya.Vector3;
    static transVertex1: Laya.Vector3;
    static transVertex2: Laya.Vector3;
	...
	static linearModel(sprite3D, lineSprite3D, color){
        ...
        CurrentTool.linearModel((sprite3D.getChildAt(i)), lineSprite3D, color);
    }

}
CurrentTool.transVertex0 = new Laya.Vector3();
CurrentTool.transVertex1 = new Laya.Vector3();
CurrentTool.transVertex2 = new Laya.Vector3();